...
<section class="research-list">
  ...
  <article class="research-item">
    ...
    <div class="research-content">
      ...
      <p>We developed a non-contact CMR (Cardiac Magnetic Resonance) gating system in collaboration with Shanghai Neusoft Medical Systems, using a dual-camera system to capture facial rPPG and chest SCG signals for robust triggers, aiming to reduce waveform distortion and delays in conventional ECG/PPG gating and improve CMR image quality and user experience. The final solution for Camera-SCG should be the structured-light-based defocused speckle method.[<a href="https://ieeexplore.ieee.org/document/11551360" target="_blank" rel="noopener">PDF</a>, <a href="https://jeit.ac.cn/en/article/doi/10.11999/JEIT251098" target="_blank" rel="noopener">PDF</a>, <a href="/assets/documents/cnPatentStructuredLightSensing.PDF" target="_blank" rel="noopener">PDF</a>, <a href="/assets/documents/cnPatentMRI.PDF" target="_blank" rel="noopener">PDF</a>, <a href="/assets/documents/cnPatentMRI-2.PDF" target="_blank" rel="noopener">PDF</a>...]</p> 
    </div> 
  </article>
